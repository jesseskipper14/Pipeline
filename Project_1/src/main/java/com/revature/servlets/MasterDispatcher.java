...
public class MasterDispatcher {
	...
	public static String process(HttpServletRequest request, HttpServletResponse response) {
		...
		case "/Project_1/logout.do": return LoginServletService.logout(request, response);
		case "/Project_1/returnLogin.do": return LoginServletService.returnLogin(request, response);
		default:{
