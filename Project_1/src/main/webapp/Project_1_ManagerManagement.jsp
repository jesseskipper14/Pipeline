<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
	...
	%>
		...
		<ul class="navbar-nav nav navbar-right col-md-2 col-md-offset-4">
				<li><input class="btn btn-danger" type="submit" value="Log Out" style="margin-top:10px"></li>		
		</ul>
		</form>
                    </nav>
                </div>
                ...
                <div id="abc">
                    <div id="popupContact">
                        ...
                        <form id="styledForm" action="popupApproveReimbursement.do" id="form" method="GET" name="form">
